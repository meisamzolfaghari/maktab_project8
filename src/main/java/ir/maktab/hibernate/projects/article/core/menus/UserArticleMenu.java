...
import ir.maktab.hibernate.projects.article.core.display.DisplayUserArticle;
...
public class UserArticleMenu extends Menu {
    ...
    public void execute() {
        ...
        while (!command.equals(Actions.back.name())) {
            ...
            if (!articles.isEmpty())
                DisplayUserArticle.displayShortVersion(articles);
            else
            ...
            if (command.equals(Actions.exit.name())) {
                ...
                if (!articles.isEmpty()) {
                    ...
                    DisplayUserArticle.displayFullVersion(chosenArticle);
